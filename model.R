...
#随机森林(RF)
set.seed(123)
Rf_benchmark=train(only1,osy,method="rf",trControl=fitControl)
print(Rf_benchmark$resample)
print(Rf_benchmark)
#随机森林(RF)
set.seed(123)
Rf_benchmark=train(only2,osy,method="rf",trControl=fitControl)
print(Rf_benchmark$resample)
print(Rf_benchmark)
#随机森林(RF)
set.seed(123)
Rf_benchmark=train(only3,osy,method="rf",trControl=fitControl)
print(Rf_benchmark$resample)
print(Rf_benchmark)
#随机森林(RF)
set.seed(123)
Rf_benchmark=train(only4,osy,method="rf",trControl=fitControl)
print(Rf_benchmark$resample)
print(Rf_benchmark)
#随机森林(RF)
set.seed(123)
Rf_benchmark=train(wi1,osy,method="rf",trControl=fitControl)
print(Rf_benchmark$resample)
print(Rf_benchmark)
#随机森林(RF)
set.seed(123)
Rf_benchmark=train(wi2,osy,method="rf",trControl=fitControl)
print(Rf_benchmark$resample)
print(Rf_benchmark)
#随机森林(RF)
set.seed(123)
Rf_benchmark=train(wi3,osy,method="rf",trControl=fitControl)
print(Rf_benchmark$resample)
print(Rf_benchmark)
#随机森林(RF)
set.seed(123)
Rf_benchmark=train(wi4,osy,method="rf",trControl=fitControl)
print(Rf_benchmark$resample)
print(Rf_benchmark)